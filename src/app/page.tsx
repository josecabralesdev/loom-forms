...
export default function Home() {
  ...
  const handleGenerateDraft = async (prompt: string) => {
    ...
    try {
      ...
      if (formStructure && formStructure.fields) {
        ...
        setFormDescription(formStructure.description || 'Your generated form preview.');
  ...
  const handleSuggestValidation = async (id: string) => {
    ...
    toast({ title: 'Thinking...', description: 'AI is suggesting validation rules.' });
    try {
      ...
      toast({ title: 'Suggestions Ready!', description: `Validation ideas for "${field.label}" are here.` });
    } catch (error) {
